  ...
  return (
    <div className="container mx-auto p-6 relative">
      ...
      <div className="absolute top-4 left-4 z-20">
        ...
        {menuOpen && (
          <div className="absolute left-0 top-10 bg-white shadow-lg rounded-lg p-4 z-10">
            <button onClick={handleProfile} className="btn btn-primary w-full mb-2">Profile</button>
